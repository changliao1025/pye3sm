...
def e3sm_create_case(sFilename_configuration_in, iFlag_continue_in = None, iFlag_debug_in = None,\
   iFlag_resubmit_in=None, iFlag_short_in=None, iCase_index_in = None, \
...
if __name__ == '__main__':
    ...
    e3sm_create_case(sFilename_configuration, iFlag_continue_in = iFlag_continue, iFlag_debug_in = iFlag_debug,\
         iFlag_resubmit_in = iFlag_resubmit , iCase_index_in = iCase,  \
