...
from e3sm.elm.general.halfdegree.plot.elm_surface_plot_variable_halfdegree_domain import elm_surface_plot_variable_halfdegree_domain

def h2sc_surface_splot_variable_halfdegree_domain(sFilename_configuration, \
                                                  iCase_index,\
                                                  iYear_start_in = None, \
                                                  iYear_end_in =None,\
    ...
    elm_surface_plot_variable_halfdegree_domain(sFilename_configuration,\
                                                iCase_index, \
...
if __name__ == '__main__':
    ...
    aCase_index = np.arange(iCase_index_start, iCase_index_end + 1, 1)
        ...
        for iCase_index in (aCase_index):
            h2sc_surface_splot_variable_halfdegree_domain(sFilename_configuration, \
                                                          iCase_index,\
