...
from e3sm.elm.general.halfdegree.plot.elm_scatterplot_variables_halfdegree_domain import elm_scatterplot_variables_halfdegree_domain

def h2sc_scatterplot_variables_halfdegree_domain(sFilename_configuration_x, \
    ...
    dSpace_y_in = None, \
                                    ...
                                    sLabel_x_in=None,\
                                        sLabel_y_in=None):
    elm_scatterplot_variables_halfdegree_domain(sFilename_configuration_x,\
        sFilename_configuration_y,\
                                   iCase_index, \
...
if __name__ == '__main__':
    ...
    for iCase_index in (aCase_index):
        h2sc_scatterplot_variables_halfdegree_domain(sFilename_configuration_x, \
            sFilename_configuration_y,\
                                    iCase_index,\
