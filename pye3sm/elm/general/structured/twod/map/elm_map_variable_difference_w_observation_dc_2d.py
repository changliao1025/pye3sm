...
def elm_map_variable_difference_w_observation_dc_2d(oE3SM_in, \
                                          oCase_x_in,\
                                            aData_y_in,\
    ...
    sWorkspace_analysis_case_region_x = sWorkspace_analysis_case_variable_x + slash + 'map_diff_w_obs_dc'
