...
def elm_map_variable_difference_dc_2d(oE3SM_in, \
                                          oCase_x_in,\
                                            oCase_y_in,\
    ...
    sWorkspace_analysis_case_region_y = sWorkspace_analysis_case_variable_y + slash + 'map_diff_dc'
    ...
    if iFlag_monthly ==1 :
        ...
        for i in np.arange(nstress_subset):
            ...
            + sVariable + '_map_diff_dc_' + sDate +'.png'         
    ...
    if iFlag_annual_mean ==1:
        ...
        for iYear in range(iYear_start, iYear_end + 1):
            ...
            sFilename_out = sWorkspace_analysis_case_region_y + slash \
            + sVariable + '_map_diff_mean_dc_'+ sYear +'.png'
    ...
    if iFlag_annual_total ==1:
        ...
        for iYear in range(iYear_start, iYear_end + 1):
            ...
            sFilename_out = sWorkspace_analysis_case_region_y + slash \
            + sVariable + '_map_diff_annual_dc_'+ sYear +'.png'
