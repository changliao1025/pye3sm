...
def elm_scatterplot_variable_x_2d(oE3SM_in,\
                                         oCase_x_in,\
                                         aData_y_in, \
                                          sVariable_y_in,\
    ...
    sFilename_out = sWorkspace_analysis_case_grid + slash + sVariable_x + '_' + sVariable_y_in + '_scatterplot.png'
    ...
    sFilename_out = sWorkspace_analysis_case_grid + slash + sVariable_x + '_' + sVariable_y_in + '_densityplot.png'
