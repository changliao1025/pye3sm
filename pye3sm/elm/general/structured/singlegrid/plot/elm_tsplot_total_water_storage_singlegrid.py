...
def elm_tsplot_total_water_storage_singlegrid(oE3SM_in, \
                                                     oCase_in, \
                                                     dMax_y_in = None,\
                                                     dMin_y_in =None):
    ...
    sWorkspace_data = oCase_in.sWorkspace_data
    ...
    sWorkspace_analysis_case = oCase_in.sWorkspace_analysis_case
    sWorkspace_analysis_case_tws = sWorkspace_analysis_case + slash + 'tsplot_tws'
