...
ncolumn = 360 * 2
#read surface data 
sWorkspace_out = '/compyfs/liao313/04model/h2sc/global/usgs_site'
...
if __name__ == '__main__':
    ...
    #print(num_cores)  
    ##num_cores = 10
    #a=np.arange(1, nrow+1, 1)
    #          
    #results = Parallel(n_jobs=num_cores, prefer="threads")(delayed(prepare_usgs_groundwater_site_list)(iRow) for iRow in a)
