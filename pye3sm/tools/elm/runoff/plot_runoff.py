...
def plot_runoff():
    sFilename_runoff = ''
    sFilename_runoff = '/compyfs/liao313/04model/e3sm/amazon/analysis/gp/' + 'minpan_runoff_extract' + sExtension_tiff
    if os.path.exists(sFilename_runoff):
        ...
        cb.ax.set_ylabel('Units: mm/s', rotation=270)
        cb.ax.tick_params(labelsize=6) 

        sFilename_out = '/compyfs/liao313/04model/e3sm/amazon/analysis/gp/ming_runoff.png'
