...
def plot_ansi():
    sFilename_runoff= '/compyfs/liao313/04model/e3sm/amazon/analysis/gp/kansi.tif'
    ...
    if os.path.exists(sFilename_runoff):
        ...
        aImage_in=np.power(10, aImage_in)
        # 
        ...
        cb.ax.set_ylabel('Unit: ratio', rotation=270)
        cb.ax.tick_params(labelsize=6) 

        sFilename_out = '/compyfs/liao313/04model/e3sm/amazon/analysis/gp/ansi.png'
