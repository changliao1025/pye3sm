            ...
            for iIndex, sVariable in enumerate(aVariable):
                if sVariable == sKey:
                    ...
                    if (iDimension == 1):
                        ...
                        # Add one attribute
                        sVariable_short = sVariable[0:6]
                        layer.CreateField(ogr.FieldDefn(sVariable_short, ogr.OFTReal))
                        ...
                        for i in range(npoint):
                            ...
                            feat.SetField(sVariable_short,value)
