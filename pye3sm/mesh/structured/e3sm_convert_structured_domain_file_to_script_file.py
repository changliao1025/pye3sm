...
def e3sm_convert_domain_file_to_script_file(sFilename_domain_in, sFilename_script_out):
    ...
    if ndim_center==2: #typical 2D. can be unstructured as well
        nj, ni, nv = grid_corner_lon.shape
        grid_rank = 2
        pass
    else:
    ...
    grid_corner_lon.shape=(ncell ,nv)
    grid_corner_lat.shape=(ncell, nv)
    ...
    pDatasets_out.createDimension('grid_corners', nv)
