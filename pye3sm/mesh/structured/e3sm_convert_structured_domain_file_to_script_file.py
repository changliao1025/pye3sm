...
def e3sm_convert_structured_domain_file_to_scripgrid_file(sFilename_domain_in, sFilename_script_out):
    ...
    if ndim_center==2: #typical 2D. can be unstructured as well
        ...
        print('Domain file is not structured 2D')
        return
...
if __name__ == '__main__':
    ...
    e3sm_convert_structured_domain_file_to_scripgrid_file(sFilename_domain,sFilename_out)
